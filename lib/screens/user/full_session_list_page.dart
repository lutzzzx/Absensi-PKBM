            ...
            Expanded(
              child: StreamBuilder(
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  // Filter sessions based on search query, selected date, and user package
                  var filteredSessions = sessions.where((session) {
                    ...
                    String sessionPackage = session['package'] ?? 'Paket A'; // Ambil paket sesi

                    bool matchesSearch = title.contains(_searchQuery);
                    bool matchesDate = _selectedDate == null ||
                        DateFormat('yyyy-MM-dd').format(sessionDate) ==
                            DateFormat('yyyy-MM-dd').format(_selectedDate!);
                    bool matchesPackage = sessionPackage == userPackage; // Filter berdasarkan paket
